            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="panel-title">项目推荐列表                                
                                     ...
                                     <a class="btn btn-primary" href="javascript:ToClick('Addrecommend')">添加</a> </div>
                </div>
                <div class="panel-body">
                    ...
                    <div class="table-responsive ">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                           <c:forEach  items="${CLRe }" var="c" varStatus="s"> 
                         						<TR
													...
													<TD> ${c.pst_name }</TD>
													<TD>
												 <a href="javascript:getdelCLR(${c.r_id })">删除推荐</a>
                    ...
                    <TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												,每页显示
													<select id="count" onchange="javascript:recommend(1)">													
														<c:choose>
												...
												<c:when test='${pb.pageNum>1 }'>
													[<A href="javascript:recommend(${pb.pageNum-1})">前一页</A>]
												</c:when>
												</c:choose>
												...
												<c:when test='${pb.pages>pb.pageNum }'>
													[<A href="javascript:recommend(${pb.pageNum+1})">后一页</A>] 
												</c:when>
												</c:choose>
